      ...
      <div className="container mx-auto px-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="w-full">
              ...
              <div className="mt-7">
                ...
                <input
                  ...
                  className="h-14 border w-full p-3"
                  aria-invalid={errors.townCity ? "true" : "false"}
                />
              </div>
          ...
          <div className="flex justify-center lg:justify-end mt-12">
            <button
              type="submit"
              className="btn bg-primary_color px-8 hover:bg-primary_hover_color hover:duration-200 hover:transition-all text-white py-4 text-sm font-bold uppercase rounded-full"
            >
              Place order
            </button>
          </div>
